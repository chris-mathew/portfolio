...
declare module '$env/static/private' {
	...
	export const ANSYS222_DIR: string;
	export const APPDATA: string;
	export const AWP_LOCALE222: string;
	export const AWP_ROOT222: string;
	export const BESIEGE_GAME_ASSEMBLIES: string;
	export const BESIEGE_UNITY_ASSEMBLIES: string;
	export const CADOE_LIBDIR222: string;
	...
	export const FLEXLM_TIMEOUT: string;
